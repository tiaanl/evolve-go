...
func TestTablePrimary(t *testing.T) {
	...
	assert.Equal(t, ColumnTypeInteger, table.Column("id").Type)
...
func TestTableString(t *testing.T) {
	...
	assert.Equal(t, ColumnTypeString, table.Column("name").Type)
	...
	assert.Equal(t, ColumnTypeString, table.Column("name2").Type)
